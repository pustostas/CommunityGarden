...
namespace CommunityGarden.Controllers
{
    public class ChatsController : Controller
    {
        ...
        public ChatsController(CommunityGardenContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Chat != null ? 
                          ...
                          Problem("Entity set 'CommunityGardenContext.Chat'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ChatId,FirstUserId,SecondUserId")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ChatId,FirstUserId,SecondUserId")] Chat chat)
        {
            if (id != chat.ChatId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CommunityGardenContext.Chat'  is null.");
            }
            var chat = await _context.Chat.FindAsync(id);
            if (chat != null)
            {
